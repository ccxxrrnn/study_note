...
```java
  <groupId>com.xw.springcloud</groupId>
...
<!--子模块继承之后，提供作用：锁定版本+子moudle不用写droupid和version-->
...
```xml
    <dependencies>
        ...
        <!--eureka client-->
<!--        在引入spring-cloud-starter-netflix-eureka-client和spring-boot-starter-web两个依赖的时候，
            会出现冲突。由于代码里面，我用了Spring MVC的Rest方式，
            而没有用spring-cloud-starter-netflix-eureka-client本身包含Jesery Rest方式。导致出现下面的BUG。-->
<!--        <dependency>-->
<!--            <groupId>org.springframework.cloud</groupId>-->
...
<mapper namespace="com.xw.springcloud.dao.PaymentDao">
    <insert id="create" parameterType="Payment" useGeneratedKeys="true" keyProperty="id">
        insert into payment(serial) values (#{serial});
    </insert>

    <resultMap id="BaseResultMap" type="com.xw.springcloud.entities.Payment">
...
```xml
        <dependency><!-- 引用自己定义的api通用包，可以使用Payment支付Entity -->
            <groupId>com.xw.springCloud_2020</groupId>
            <artifactId>cloud-api-commons</artifactId>
            <version>${project.version}</version>
        </dependency>
```
...
![img](https://img-blog.csdn.net/20171130145936759?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdTAxNDQwMTE0MQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
